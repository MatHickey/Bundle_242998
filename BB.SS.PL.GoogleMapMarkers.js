...
define(['N/url', 'N/runtime', 'N/file', 'N/render', 'N/search'], function(urlModule, runtimeModule, fileModule, renderModule, searchModule){
  ...
  _export.render = function(params){
    var
      ...
      , _searchId = _currentScript.getParameter({name: 'custscript_map_control_search'})
      , _title = _currentScript.getParameter({name: 'custscript_map_control_title'})
      , _url = urlModule.resolveScript({
        scriptId: 'customscript_bb_ss_sl_google_map_markers',
        deploymentId: 'customdeploy_bb_ss_sl_google_map_markers',
        params: {
          searchId: _searchId
        }
      })
